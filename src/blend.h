...
typedef enum _drawableop DrawableOp;

typedef void (*DrawableBlendFunction)(DATA32*, int, DATA32*, int, int, int,
				   DrawableColorModifier *);

__hidden DrawableBlendFunction
__drawable_GetBlendFunction(DrawableOp op, char merge_alpha, char blend, char rgb_src,
...
#ifdef DO_MMX_ASM
void
__drawable_mmx_blend_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
                              int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_blend_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
			       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_copy_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
			     int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_copy_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
                              int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_copy_rgb_to_rgba(DATA32 *src, int sw, DATA32 *dst,
			     int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_add_blend_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
				  int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_add_blend_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				   int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_add_copy_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
				 int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_add_copy_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				  int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_add_copy_rgb_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				  int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_subtract_blend_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_subtract_blend_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
					int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_subtract_copy_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_subtract_copy_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_subtract_copy_rgb_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_reshade_blend_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_reshade_blend_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_reshade_copy_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
				     int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_reshade_copy_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_reshade_copy_rgb_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);

void
__drawable_mmx_blend_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
                              int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_blend_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
			       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_blend_rgb_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
                              int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_blend_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
			       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_copy_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
			     int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_copy_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
                              int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_copy_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
			     int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_add_blend_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				  int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_add_blend_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				   int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_add_blend_rgb_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				  int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_add_blend_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				   int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_add_copy_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				 int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_add_copy_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				  int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_add_copy_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				  int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_subtract_blend_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_subtract_blend_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
					int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_subtract_blend_rgb_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_subtract_blend_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
					int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_subtract_copy_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_subtract_copy_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_subtract_copy_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_reshade_blend_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_reshade_blend_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_reshade_blend_rgb_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_reshade_blend_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_reshade_copy_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				     int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_reshade_copy_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_mmx_reshade_copy_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
#elif DO_AMD64_ASM
void
__drawable_amd64_blend_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
                              int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_blend_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
			       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_copy_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
			     int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_copy_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
                              int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_copy_rgb_to_rgba(DATA32 *src, int sw, DATA32 *dst,
			     int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_add_blend_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
				  int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_add_blend_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				   int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_add_copy_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
				 int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_add_copy_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				  int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_add_copy_rgb_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				  int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_subtract_blend_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_subtract_blend_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
					int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_subtract_copy_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_subtract_copy_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_subtract_copy_rgb_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_reshade_blend_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_reshade_blend_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_reshade_copy_rgba_to_rgb(DATA32 *src, int sw, DATA32 *dst,
				     int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_reshade_copy_rgba_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_reshade_copy_rgb_to_rgba(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);


void
__drawable_amd64_blend_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
                              int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_blend_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
			       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_blend_rgb_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
                              int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_blend_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
			       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_copy_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
			     int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_copy_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
                              int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_copy_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
			     int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_add_blend_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				  int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_add_blend_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				   int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_add_blend_rgb_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				  int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_add_blend_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				   int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_add_copy_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				 int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_add_copy_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				  int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_add_copy_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				  int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_subtract_blend_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_subtract_blend_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
					int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_subtract_blend_rgb_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_subtract_blend_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
					int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_subtract_copy_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_subtract_copy_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_subtract_copy_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_reshade_blend_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_reshade_blend_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_reshade_blend_rgb_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_reshade_blend_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				       int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_reshade_copy_rgba_to_rgb_cmod(DATA32 *src, int sw, DATA32 *dst,
				     int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_reshade_copy_rgba_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
void
__drawable_amd64_reshade_copy_rgb_to_rgba_cmod(DATA32 *src, int sw, DATA32 *dst,
				      int dw, int w, int h, DrawableColorModifier *cm);
#endif
#endif
