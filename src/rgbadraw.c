...
void
__drawable_FlipImageHoriz(DrawableImage * im)
{
   DATA32             *p1, *p2, tmp;
   int                 x, y;
...
void
__drawable_FlipImageVert(DrawableImage * im)
{
   DATA32             *p1, *p2, tmp;
   int                 x, y;
...
void
__drawable_FlipImageBoth(DrawableImage * im)
{
   DATA32             *p1, *p2, tmp;
   int                 x;
...
\*/
void
__drawable_FlipImageDiagonal(DrawableImage * im, int direction)
{
   DATA32             *data, *to, *from;
   int                 x, y, w, hw, tmp;
...
void
__drawable_BlurImage(DrawableImage * im, int rad)
{
   DATA32             *p1, *p2, *data;
...
void
__drawable_SharpenImage(DrawableImage * im, int rad)
{
   DATA32             *data, *p1, *p2;
   int                 a, r, g, b, x, y;
...
void
__drawable_TileImageHoriz(DrawableImage * im)
{
...
void
__drawable_TileImageVert(DrawableImage * im)
{
   DATA32             *p1, *p2, *p, *data;
...
void
__drawable_copy_image_data(DrawableImage * im, int x, int y, int w, int h, int nx,
                        int ny)
{
   int                 xx, yy, jump;
   DATA32             *p1, *p2;
...
void
__drawable_copy_alpha_data(DrawableImage * src, DrawableImage * dst, int x, int y,
