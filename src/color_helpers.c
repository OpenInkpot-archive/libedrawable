...
void
__drawable_rgb_to_hsv(int r, int g, int b, float *h, float *s, float *v)
{
   float               min, max, delta;
...
void
__drawable_hsv_to_rgb(float h, float s, float v, int *r, int *g, int *b)
{
   float               f, vf;
   int                 i, p, q, t, vv;
...
void
__drawable_rgb_to_hls(int r, int g, int b, float *hue, float *lightness,
                   float *saturation)
{
   int                 f;
...
void
__drawable_hls_to_rgb(float hue, float lightness, float saturation, int *r, int *g,
                   int *b)
{
   float               m1, m2, m21, h;
