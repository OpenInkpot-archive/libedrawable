...
static void
__drawable_Ellipse_DrawToData(int xc, int yc, int a, int b, DATA32 color,
                           DATA32 * dst, int dstw, int clx, int cly, int clw,
                           int clh, DrawableOp op, char dst_alpha, char blend)
{
...
static void
__drawable_Ellipse_DrawToData_AA(int xc, int yc, int a, int b, DATA32 color,
                              DATA32 * dst, int dstw, int clx, int cly, int clw,
                              int clh, DrawableOp op, char dst_alpha, char blend)
{
   DrawablePointDrawFunction pfunc;
...
static void
__drawable_Ellipse_FillToData(int xc, int yc, int a, int b, DATA32 color,
                           DATA32 * dst, int dstw, int clx, int cly, int clw,
                           int clh, DrawableOp op, char dst_alpha, char blend)
{
   DrawablePointDrawFunction pfunc;
...
static void
__drawable_Ellipse_FillToData_AA(int xc, int yc, int a, int b, DATA32 color,
                              DATA32 * dst, int dstw, int clx, int cly, int clw,
                              int clh, DrawableOp op, char dst_alpha, char blend)
{
   DrawablePointDrawFunction pfunc;
                            ...
                            DrawableOp op, char blend, char anti_alias)
{
   ...
   if ((a == 0) || (b == 0))
     {
        (void)__drawable_Line_DrawToImage(xc - a, yc - b, xc + a, yc + b, color,
                                       im, clx, cly, clw, clh,
   ...
   if (anti_alias)
      __drawable_Ellipse_DrawToData_AA(xc, yc, a, b, color,
                                    im->data, im->w, clx, cly, clw, clh,
                                    op, IMAGE_HAS_ALPHA(im), blend);
   else
      __drawable_Ellipse_DrawToData(xc, yc, a, b, color,
                                 im->data, im->w, clx, cly, clw, clh,
                                 op, IMAGE_HAS_ALPHA(im), blend);
}
                            ...
                            DrawableOp op, char blend, char anti_alias)
{
   ...
   if (anti_alias)
      __drawable_Ellipse_FillToData_AA(xc, yc, a, b, color,
                                    im->data, im->w, clx, cly, clw, clh,
                                    op, IMAGE_HAS_ALPHA(im), blend);
   else
      __drawable_Ellipse_FillToData(xc, yc, a, b, color,
                                 im->data, im->w, clx, cly, clw, clh,
                                 op, IMAGE_HAS_ALPHA(im), blend);
}
